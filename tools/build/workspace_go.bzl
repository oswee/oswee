...
def prime_go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:VpafO/KGTHfUZSJ/3FgibSr/BPZELlJ+ZiozqN/YHNc=",
        version = "v0.0.0-20201009151607-0f0230183423",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_matryer_goblueprints",
        importpath = "github.com/matryer/goblueprints",
        sum = "h1:HPeAn2kjzE3vJNCKTJkXnIieUhEC5lYkmceoppfIm1M=",
    ...
    go_repository(
        name = "com_github_oswee_api",
        importpath = "github.com/oswee/api",
        sum = "h1:8bObvYiFDavFZKW10nJ2A5kwIs7Kz0DcFpfIMx6orJ0=",
        version = "v0.4.0",
    )
    go_repository(
