...
- You [should not](https://github.com/bazelbuild/rules_go#can-i-still-use-the-go-command) run `go` tool from this repository.
  ...
  handled by Gazelle. Gazelle.All Go and Protobuf dependencies should be handled by Gazelle. All Go and Protobuf dependencies should be handled by Gazelle.
