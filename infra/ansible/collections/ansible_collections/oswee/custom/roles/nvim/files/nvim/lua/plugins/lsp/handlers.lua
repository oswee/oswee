...
-- Executes only when the language server attaches the buffer
...
if not ok then
	vim.api.nvim_err_writeln('[LSP] `cmp_nvim_lsp` plugin not installed! Please install via your plugin manager.')
	return
end
