resource "null_resource" "instance_config" {
  ...
  provisioner "local-exec" {
    working_dir = "../../../../ansible"
    # command     = "ANSIBLE_FORCE_COLOR=1 ansible-playbook -i environments/development playbooks/dns.yaml"
    command     = "ansible-playbook -i environments/development playbooks/dns.yaml"
  }
