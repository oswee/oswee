...
import { store, connect, RootState, WebsocketSelectors, Application } from '../../../../../store/src'
import { Theme } from '../../../../../assets/style'
import template from './template'
import style from './style'
import { ViewDispatchConsignmentsElement } from '../../../view-dispatch-consignments/src'
